...
class Rob_top_layer(Environment):
    ...
    def __init__(self, middle, timeout=160, locations = {'o103':(0,0), 
                          'o109':(50,10), 'o119':(65,50),'BIT26':(40,51),'BCS13':(34,32), 'Goal':(30,-10)} ):
...
class Plot_env(object):
    def __init__(self, body,top):
        ...
        plt.draw()
        plt.title('Assignment : Delivery Robot [3% Marks]. Deadline : 24 Oct. Classes:IT & CS ')
...
top.do({'visit':['o103','o109','o119','BIT26','BCS13','Goal']})
